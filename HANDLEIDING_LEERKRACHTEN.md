# Handleiding Uitleenbalie & Klasbeheer 📚
### Voor Leerkrachten & Secretariaat — Boekenbende Sint-Pieters (Don Bosco Gent)

Welkom bij de beknopte handleiding van **Boekenbende Sint-Pieters**, speciaal samengesteld voor alle **collega-leerkrachten** (o.a. Nederlands, moderne talen, instapklassen) en **secretariaatsmedewerkers** aan de bib-balie.
...
1. [Snelle Start: Wat is jouw rol?](#1-snelle-start-wat-is-jouw-rol)
2. [Boeken zoeken & Kiezen met leerlingen](#2-boeken-zoeken--kiezen-met-leerlingen)
3. [Boeken Uitlenen (2 eenvoudige manieren)](#3-boeken-uitlenen-2-eenvoudige-manieren)
   - [Manier A: Rechtstreeks vanuit het boekvenster (in de klas)](#manier-a-rechtstreeks-vanuit-het-boekvenster)
   - [Manier B: Aan de Uitleenbalie (met barcode of invoer)](#manier-b-aan-de-uitleenbalie)
4. [Boeken Terugbrengen & Innemen](#4-boeken-terugbrengen--innemen)
   - [Bliksemsnel met de barcodescanner](#bliksemsnel-met-de-barcodescanner)
   - [Handmatig opzoeken en inleveren](#handmatig-opzoeken-en-inleveren)
   - [De staat van het boek registreren](#de-staat-van-het-boek-registreren)
5. [Klasbeheer na een leesuur: Alles van een klas inleveren](#5-klasbeheer-na-een-leesuur)
6. [Veelgestelde Vragen (FAQ): Uitlenen & Terugbrengen](#6-veelgestelde-vragen-faq-uitlenen--terugbrengen)
   - [FAQ 1: Wat is de leerkrachtcode en waarom is die nodig?](#faq-1-wat-is-de-leerkrachtcode-en-waarom-is-die-nodig)
   - [FAQ 2: Moet ik de code bij elk boek opnieuw intypen?](#faq-2-moet-ik-de-code-bij-elk-boek-opnieuw-intypen)
   - [FAQ 3: Wat is de standaard uitleentermijn en hoe verleng ik een boek?](#faq-3-wat-is-de-standaard-uitleentermijn-en-hoe-verleng-ik-een-boek)
   - [FAQ 4: Wat als een boek al uitgeleend is?](#faq-4-wat-als-een-boek-al-uitgeleend-is)
   - [FAQ 5: Wat doe ik als een boek beschadigd wordt ingeleverd?](#faq-5-wat-doe-ik-als-een-boek-beschadigd-wordt-ingeleverd)
   - [FAQ 6: Hoe zie ik welke boeken van mijn klas nog openstaan of 'te laat' zijn?](#faq-6-hoe-zie-ik-welke-boeken-van-mijn-klas-nog-openstaan-of-te-laat-zijn)
   - [FAQ 7: Wat als de handscanner niet piept of het boek geen barcode heeft?](#faq-7-wat-als-de-handscanner-niet-piept-of-het-boek-geen-barcode-heeft)
   - [FAQ 8: Kan een collega-leerkracht ook een boek ontlenen?](#faq-8-kan-een-collega-leerkracht-ook-een-boek-ontlenen)
   - [FAQ 9: Kunnen leerlingen zelf van thuis uit boeken ontlenen of inleveren?](#faq-9-kunnen-leerlingen-zelf-van-thuis-uit-boeken-ontlenen-of-inleveren)
   - [FAQ 10: Moet ik de balie vergrendelen als ik klaar ben?](#faq-10-moet-ik-de-balie-vergrendelen-als-ik-klaar-ben)
...
1. **Zoeken**: Typ een trefwoord, auteur of titel in de zoekbalk (bv. *"oorlog"*, *"Kruistocht in spijkerbroek"*, *"Dirk Bracke"*).
2. **Filters**:
   - **Leeftijd / Graad**: *Eerste graad* (12-14 j.), *Tweede graad* (14-16 j.) of *Derde graad* (16+ j.).
   - **Taal**: Handig voor moderne vreemde talen (*Engels*, *Frans*, *Duits*).
   - **Nu in de bib aanwezig**: Vink dit aan om enkel boeken te zien die momenteel fysiek in de rekken staan.
3. **Achterflap & Recensies**: Klik op een boek en kies de knop **'Meer informatie'** om recensies van leeftijdsgenoten te lezen via Boekenzoeker.be of Hebban.nl.
...
5. Klik op deze knop en bevestig.  
   **Alle uitleningen van die klas worden in één seconde gelijktijdig afgesloten!**
...
2. Klik op de filterknop van jouw klas.
3. In de tabel zie je meteen de status per leerling: boeken waarvan de inleverdatum verstreken is, worden gemarkeerd met een rode badge **Te laat**. Handig om even aan te kaarten aan het begin van de les!
...
- Het systeem zoekt realtime in de catalogus en stelt de juiste titel voor.
...
*Veel succes en leesplezier gewenst met je klas!  
Bij vragen kun je steeds terecht bij de bib-verantwoordelijken van Campus Sint-Pieters.*
